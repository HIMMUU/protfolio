...
const Footer = () => {
  return (
    <footer className="relative w-full pt-20 pb-10 z-10 bg-black-100" id="contact">
      {/* background grid */}
      ...
      <div className="relative flex flex-col items-center z-20">
        ...
        <a href="mailto:himeshg4@gamil.com">
          <MagicButton
      ...
      <div className="relative flex mt-16 md:flex-row flex-col justify-between items-center z-20">
        <p className="md:text-base text-sm md:font-normal font-light">
          Copyright © 2025 Himesh Gupta
        </p>
