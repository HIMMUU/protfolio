...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[40vh] flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <motion.div
          ...
          className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-black-100 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ opacity: 0 }}
